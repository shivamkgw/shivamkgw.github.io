...
├── assets/
│   ├── img/
│   │   ├── logos/          # Affiliation logos (UvA, Lab42, CSL, MetaHealth)
...
- Custom amber cursor with lagging ring
- Scroll-linked horizontal timeline
- Research card image lightbox
- Scrapbook section sidebar nav with scroll progress bar
